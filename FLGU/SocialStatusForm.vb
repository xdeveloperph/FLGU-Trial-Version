...
Public Class SocialStatusForm
    ...
    Private Sub btnadd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnadd.Click
        ...
        If credentiaos.create = True Then
            If (tboccupation.Text <> "" And tboccupation.Text <> " " And tboccupation.Text <> Nothing) Then
                presenter.InsertToSocialStatus(tboccupation.Text, "")
                tboccupation.Clear()
                LoadDataGridview()
    ...
    Private Sub btnsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsave.Click
        ...
        If (result = MsgBoxResult.Yes) Then
            presenter.UpdateSocialStatus(dieseaseid, tboccupation.Text)
            LoadDataGridview()
            cm1()
    ...
    Private Sub btnremove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnremove.Click
        ...
        If credentiaos.delete = True Then
            ...
            Dim i = DataGridView1.CurrentRow.Index
            If (result = MsgBoxResult.Yes) Then
                presenter.RemoveSocialStatus(DataGridView1.Item(0, i).Value)
                LoadDataGridview()
                cm1()
    ...
    Private Sub LoadDataGridview()
        ...
        bindingsouce.DataSource = presenter.GetListofSocialStatus()
        DataGridView1.DataSource = bindingsouce
        DataGridView1.Columns(0).HeaderText = "Record #"
        DataGridView1.Columns(1).HeaderText = "Occupation"
        DataGridView1.Columns(2).HeaderText = "Date Created"
        DataGridView1.Columns(3).HeaderText = "Remove"
        DataGridView1.Columns(3).Visible = False
        DataGridView1.ClearSelection()
    End Sub
    Private Sub tbcityname_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles tboccupation.KeyPress
